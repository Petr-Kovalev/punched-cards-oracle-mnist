...
using PunchedCards.Helpers.OracleMNIST;
...
namespace PunchedCards.Helpers
{
    internal static class DataHelper
    {
        ...
        {
            return LoadData("TrainingData.json", OracleMnistReader.ReadTrainingData);
        }

        internal static IReadOnlyList<ValueTuple<IBitVector, IBitVector>> LoadTestData()
        {
            return LoadData("TestData.json", OracleMnistReader.ReadTestData);
        }
