...
namespace PunchedCards.Helpers.QMNIST
{
    ...
    {
        private const string TrainImagesFileName = "oracle-mnist/train-images-idx3-ubyte";
        private const string TrainLabelsFileName = "oracle-mnist/train-labels-idx1-ubyte";
        private const string TestImagesFileName = "oracle-mnist/t10k-images-idx3-ubyte";
        private const string TestLabelsFileName = "oracle-mnist/t10k-labels-idx1-ubyte";
